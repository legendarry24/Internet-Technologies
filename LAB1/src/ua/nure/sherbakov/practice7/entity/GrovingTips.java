...
@XmlType(name = "GrovingTips", propOrder = { "temperature", "lighting", "watering" })
public class GrovingTips {
	...
	public String toString() {
		return new StringBuilder().append("Groving tip: Temperature = ").append(getTemperature())
				.append("\nGroving tip: Lighting = ").append(isLighting())
				.append("\nGroving tip: Watering = ").append(getWatering()).toString();
	}
