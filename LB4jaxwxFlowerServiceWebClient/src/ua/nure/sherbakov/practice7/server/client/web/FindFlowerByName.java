...
/**
 * Servlet implementation class FindFlowerByTitle
 * 
 */

public class FindFlowerByName extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private static final Log log = Log.getInstance(Log.DEBUG, FindFlowerByName.class);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		List<Flower> flowers = service.findByName(pattern);
